...
//   yield takeEvery(actions.RESET_PASSWORD_OTP, function* ({ payload, cbSuccess, cbError }) {
//     try {
//       var { model } = payload;
//       var response = yield call(authServices.resetPasswordWithOtp, JSON.stringify(model));
//       if (response.data.success) {
//         yield cbSuccess();
//       }
//     }
